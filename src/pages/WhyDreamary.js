      ...
      <div className="container-fluid d">
        <div className="d_bg" style={{padding: 0}}>
          <div className="d_container why text-center">
            ...
            <Link to='/addDesigner'>
              <div className='why_button'>지금 바로 등록하기!</div>
            </Link>
              <div className='why_content1'>
              아무리 홍보를 해도 안구해지는 헤어모델 때문에<br/>
              혹시 스트레스 받고 계시지는 않으신가요?</div>
              <img src={why1} alt='alt' style={{width: '60%', marginTop: '44.7px'}}/>
            </div>
            <div className='why_content2'>헤어모델이 안구해지는데는 사실 이유가 있었습니다.</div>
            ...
            <div className='why_content2' style={{color: 'rgba(0, 0, 0, 0.1)', marginTop: 0}}>
            ...
            <div className='why_1 p'>대신 드리머리는 약속드릴 수 있습니다.</div>
            <div className='why_content2' style={{textAlign: 'left', margin: '43px auto'}}>
            ...
            <div className='why_imgBack'>
              ...
              <div className='why_imgText2'>*실제 설문/댓글 등에 참여한 고객의 목소리임을 법적으로 보장합니다.</div>
            </div>
            <div className='why_content3'>더 이상 모델 구하는 일로 혼자 스트레스 받지 마세요.</div>
            <div className='why_content4'>드리머리는 당신의 소중한 꿈을 응원합니다.</div>
            <div className='d-flex' style={{alignItems: 'center', marginLeft: '17.7%'}}>
