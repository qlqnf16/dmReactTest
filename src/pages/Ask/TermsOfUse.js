...
const TermsOfUse = () => (
  <div className="container-fluid ask">
    ...
    <p className='ask_content' style={{whiteSpace: 'pre-line', wordBreak: 'break-all'}}>
    제1조(목적)
...
⑦ ‘이용권’이라 함은 예디의 월간 정기 이용권, 그리고 고객이 서비스를 받기 위해 “플랫폼”에서 구매하는 커트 이용권 모두를 의미할 수 있습니다.

제3조 (약관 등의 명시와 설명 및 개정) 

① “플랫폼”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 플랫폼의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
③ 회사는 예디에게 예디 소개를 지나치게 상세하게 작성하는 것 또는 고객에게 리뷰를 작성할 것을 부당하게 강요하지 않습니다.
...
③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “플랫폼”은 제8조에 정한 방법으로 이용자에게 통지하고 당초 “플랫폼”에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, “플랫폼”이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 “플랫폼”에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
...
1. 네이버페이, 카카오페이 등 간편결제 
2. 선불카드, 직불카드, 신용카드 등의 각종 카드 결제
3. 온라인 무통장입금
4. 쿠폰 등 “플랫폼”이 지급한 수단에 의한 결제
...
① 이용권 환급은 서비스 진행 전 예디나 고객의 변심, 개인사정 등의 이유로 서비스가 불가해짐에 따라 이용자가 요청하는 것을 의미합니다. 이는 서비스 진행 이후 고객의 불만족에 따라 발생하는 “이용권 복구” 와 구분됩니다.

② “플랫폼”은 고객이 구매한 이용권에 대해서 환급요청이 있을 경우 당사의 지침에 저촉되지 않는 한 이를 지체 없이 이행합니다.

③ 환급에 대한 구체적인 지침은 다음과 같습니다.
1. 서비스 시작 24시간 이전에 고객이 환급을 요청한 경우 이용권이 환급됩니다. 24시간 이내에는 불가능하며 이 때 이용권은 소멸됩니다.
2. 예디의 사정으로 인하여 예약이 파기된 경우 필히 고객에게 이용권을 환급합니다. 예디 또는 고객의 타당한 이유 없는 환급요청이 잦을 경우에는 해당 이용자의 서비스 이용이 제한될 수 있습니다. 
3. 예디는 월 정기권 형태의 이용권이 운영되는 특징상 환급이 불가합니다. 대신 공고 일시정지를 통해 일정기간 이용권의 사용을 보류하고 남은 기간은 미래에 언제든지 사용할 수 있습니다.

제15조(이용권 복구)

① 이용권 복구는 고객이 서비스를 받은 후 그 품질에 대해 불만족하거나 서비스가 예정대로 이행되지 않았을 경우 당사에게 요청할 수 있습니다. 당사는 본 요청에 대해 내부 위원회의 검토 후 최대한 빠른 시일 내에 이용권을 복구/소멸 조치합니다.

② 고객은 다음 각 호의 1에 해당하는 경우에는 이용권 복구요청을 할 수 없습니다.

1. 서비스 예약 후 고객 스스로에게 책임 있는 사유로 서비스가 제공되지 못한 경우
2. 고객의 과실 또는 책임으로 인해 예디의 영업 또는 평판 상 중대한 손실이 발생하거나 예상되는 경우 
3. 금전적 이익을 목적으로 고의로 이용권을 복구할 것을 당사에게 요청하는 것으로 판단되는 경우

제16조(이용권 복구 등의 효과)

① “플랫폼”은 고객의 이용권 복구 요구 시 위원회 내에서 검토 후 복구 절차를 진행합니다. 이용권 복구 시 사용된 이용권을 고객의 계정에 복구합니다.

② “플랫폼”은 이용자에게 이용권 복구 등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 서비스 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 이용권 복구에 필요한 비용은 “플랫폼”이 부담합니다.
...
⑤ 지속적인 당일 취소 또는 서비스 무단 불참이 확인될 경우 플랫폼은 다음과같은 조치를 취할 수 있습니다. 고객 – 본 이용권까지만 사용 가능, 이후 추가적인 이용권 구매 불가 또는 강제탈퇴. 예디 – 공고정지 또는 강제탈퇴. 예디의 경우 공고가 정지 되었을 경우에도 사전에 예약이 완료된 서비스에 대해서는 해당 일자에 서비스를 진행해야합니다.
...
② 연결 “플랫폼”은 피연결“플랫폼”이 독자적으로 제공하는 서비스 등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않습니다.
