...
class WhyDreamary extends Component {
  ...
  render() {
    return (
      <Fragment>
        <div className="text-center" style={{ paddingTop: '18.9px' }}>
          ...
          <div className="m_why_back">
            <div onClick={() => this.clickButton()} className="m_why_button">
              지금 바로 등록하기!
            </div>
            ...
            <img
              src={why1}
              alt="alt"
              style={{ width: '95%', marginTop: '14.8px' }}
            />
          </div>
          ...
          <div className="m_why_roundBack">
            ...
            <div className="m_why_roundText">
              ...
              <br />
              근데 너무 <span style={{ color: '#dd6866' }}>못잘라서</span> 그런
              것 아닌가요”
            </div>
            <div className="m_why_roundText">
              “다른사람의 후기나 포트폴리오 같은 것을
              <br />
              보고 <span style={{ color: '#dd6866' }}>안심</span>할 수 있으면 갈
              것 같아요”
            </div>
          </div>
          <div className="m_why_content2">
          ...
          <div className="m_why_back g">
            ...
            <div className="m_why_content1" style={{ color: 'white' }}>
              ...
              <br />
              응답한 사람의 비율이{' '}
              <span style={{ color: '#dd6866' }}>87.2%로 매우 높게</span>{' '}
              집계되었습니다.
            </div>
          </div>
          <div
          ...
          >
            드리머리는 예디(예비 헤어디자이너)와 대중을 연결하는 전문적인 플랫폼
            <br />
            입니다. 인스타그램과 다르게 신뢰도의 핵심인 ‘리뷰’기능이 도입되며,
            <br />
          ...
          <div
            className="m_why_content2"
            style={{ textAlign: 'left', margin: '13.4px 0 43px 16.2px' }}
          >
            - 하루종일 모델을 구하느라 온 정신을 쏟고
            <br />
            <br />- 개인 인스타그램이 헤어모델 구인스타그램으로 쓰일 정도로
            <br /> 홍보를 하지만 모델이 잘 안구해지고
            <br />
            <br />- 모델을 문의드린다며 들어온 DM을 보고 일일이 장소, 시간,
            <br />
            가격 유의사항 등 이야기해드렸더니 결국 죄송하다며 마지막에
            <br />
            떠나버리는 고객을 보고 현자타임을 느끼고
            <br />
            <br />- 전날 밤 갑자기 모델이 못온다고 하여 길거리캐스팅을 떠나야
            하는 순간들
            <br />
            <br />
            <br />
          ...
          <div className="m_why_imgBack">
            ...
            <div className="m_why_imgText2">
              *실제 설문/댓글 등에 참여한 고객의 목소리임을 법적으로 보장합니다.
            </div>
          </div>
          <div className="m_why_content3">
            더 이상 모델 구하는 일로 혼자 스트레스 받지 마세요.
          </div>
          <div className="m_why_content4">
          ...
          <div onClick={() => this.clickButton()} className="m_why_button2">
            지금 바로 등록하기!
          </div>
          <img
            alt="alt"
            src={logo}
            style={{ width: '10%', marginBottom: '49.5px' }}
          />
        </div>
        <MyModal
