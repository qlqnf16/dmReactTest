    ...
    return (
      <div className="text-center" style={{ paddingTop: '18.9px' }}>
        <div className="m_why_1">
          헤어모델,
          <br />
          <span style={{ color: '#dd6866', fontWeight: 'bold' }}>드리머리</span>
          에서 쉽고 빠르게 구해보세요.
        </div>
        ...
        <div className="m_why_roundBack">
          ...
          <div className="m_why_roundText">
            ...
            <br />
            근데 너무 <span style={{ color: '#dd6866' }}>못잘라서</span> 그런 것
            아닌가요”
          </div>
          <div className="m_why_roundText">
        ...
        <div
          className="m_why_content2"
          style={{ textAlign: 'left', marginTop: '28px', marginBottom: '34px' }}
        >
        ...
        >
          ...
          <br />
          <br />- 전날 밤 갑자기 모델이 못온다고 하여 길거리캐스팅을 떠나야 하는
          순간들
          <br />
          <br />
          <br />
