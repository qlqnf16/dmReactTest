        ...
        <div className='m_landing_back'>
          ...
          <div className='text-left'>
            <div className='m_landing_title'>
              드리머리는<br/>
              <span style={{borderBottom: 'solid 3px #dd6866'}}>합리적인 가격</span>을 제시합니다</div>
            <div className='m_landing_content'>
            다듬기만 하는데도 만원이 훌쩍 넘는 가격, 부담되셨죠? <br/>
드리머리에서 5,000원에 헤어 서비스를 받아보세요.</div>
          </div>
        </div>
        <div className='m_landing_back' style={{backgroundColor: 'white'}}>
          ...
          <div className='text-left'>
            <div className='m_landing_title'>
              드리머리는<br/>
              <span style={{borderBottom: 'solid 3px #4c91ba'}}>확실한 실력</span>을 보장합니다</div>
            <div className='m_landing_content'>
              드리머리 예디들은 자격증은 물론 수년의 견습실력을<br/>
              갖췄습니다. 다른 사람들이 남긴 리뷰와 별점을 보고<br/>
              내게 맞는 예디를 직접 찾아보세요.</div>
          </div>
        </div>
        <div className='m_landing_back'>
          ...
          <div className='text-left'>
            <div className='m_landing_title'>
              드리머리는<br/>
              <span style={{borderBottom: 'solid 3px #dd6866'}}>건강한 소비</span>를 지향합니다
            </div>
            <div className='m_landing_content'>
              곧 프로 헤어디자이너로 승급 할 예디들에게<br/>
              서비스를 받을 수 있는 마지막 기회입니다.<br/>
              예디들의 꿈과 가능성에 힘이 되어주세요.
            </div>
          </div>
        </div>
        <div className='m_landing_back' style={{backgroundColor: 'white', padding: '0 10%'}}>
          <div className='m_landing_title' style={{margin: '0 0 70px 0px', alignSelf: 'start'}}>
            드리머리는<br/>
            <span style={{borderBottom: 'solid 3px #4c91ba'}}>이용이 간편</span>합니다
          </div>
        ...
        <div className='m_landing_back' style={{backgroundColor: '#393939'}}>
          ...
          <div className='m_landing_content2'>
            드리머리는 예비 전문가가 전문가로 나아가기 위해<br/>
            필요한 것과 문제점을 찾고 해결하고자 하는 <span style={{fontWeight: 'bold', color: '#fffae3'}}>소셜벤처</span>로,<br/>
            각 분야 사회 초년생 <span style={{fontWeight: 'bold', color: '#fffae3'}}>개개인의 가치를 발굴</span>하고<br/>
            합리적 소비를 꿈꾸는 <span style={{fontWeight: 'bold', color: '#fffae3'}}>대중과 연결</span>하는 플랫폼입니다.
          </div>
