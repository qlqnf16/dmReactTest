...
class FAQ extends Component {
  constructor(props) {
    ...
    this.designerToggler = this.designerToggler.bind(this)
    this.userToggler = this.userToggler.bind(this)
  }
  ...
  designerFAQ = (
    <div>
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">1</div>
          <div className="m_ask_question font-weight-bold">
            모델은 몇 명까지 구인할 수 있나요?
          </div>
          <div />
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">2</div>
          <div className="m_ask_question font-weight-bold">
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">3</div>
          <div className="m_ask_question font-weight-bold">
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">4</div>
          <div className="m_ask_question font-weight-bold">
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">5</div>
          <div className="m_ask_question font-weight-bold">
            아무나 예디로 등록할 수 있나요?
          </div>
          <div />
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">6</div>
          <div className="m_ask_question font-weight-bold">
            작업 진행은 어디에서 하면 되나요?
          </div>
          <div />
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">7</div>
          <div className="m_ask_question font-weight-bold">
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">8</div>
          <div className="m_ask_question font-weight-bold">
            고객들은 어떻게 저희를 찾나요?
          </div>
          <div />
  ...
  userFAQ = (
    <div>
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">9</div>
          <div className="m_ask_question font-weight-bold">
      ...
      <div className="m_ask_list">
        <div className="m_ask_grid">
          <div className="m_ask_qnum">10</div>
          <div className="m_ask_question font-weight-bold">
            쿠폰의 유효기간은 어떻게 되나요?
          </div>
          <div />
  ...
  render() {
    let navD = this.state.isD ? 'm_ask_faqnavitem active' : 'm_ask_faqnavitem'
    let navU = !this.state.isD ? 'm_ask_faqnavitem active' : 'm_ask_faqnavitem'
      ...
      <div>
        ...
        <div className='container-fluid m_ask' style={{width: '96.8%'}}>
          ...
          <div className='m_ask_faqnav'>
            ...
            <div className={navU} onClick={this.userToggler}>유저</div>
          </div>
          {this.state.isD ? this.designerFAQ : this.userFAQ}
        </div>
      </div>
    )
  }
